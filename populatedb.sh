...
# create test users
docker exec -i brainlife_mongodb_1 mongo <<'EOF'
use auth
...
docker exec brainlife_mongodb_1 rm -rf /tmp/dump
docker cp dbdump brainlife_mongodb_1:/tmp/dump
docker exec brainlife_mongodb_1 mongorestore /tmp/dump
