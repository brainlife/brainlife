...
bulk.find({_id: ObjectId("6307d234e7498d276ff988db")}).upsert().updateOne({
    ...
    "config" : {
        ...
        "services" : [
            { "name" : "brainlife/validator-neuro-dwi", "score" : NumberInt(10) },
            { "name" : "brainlife/validator-neuro-anat", "score" : NumberInt(10) },
            { "name" : "brainlife/validator-neuro-track", "score" : NumberInt(10)  },
